...
if __name__ == '__main__':
    ...
    parser.add_argument("-rot", "--reprojection_remove_outliers", type=src.str2bool, default='y', help="Whether to remove outliers based on reprojection error or not")
    parser.add_argument("-rott", "--reprojection_outlier_threshold", type=float, default=25.0, help="Threshold for reprojection error to remove outliers")
