...
def subdivision_loop(mesh, iterations: int = 1, output_dir: str = '../assets/results/assignment1'):
    """
...
def simplify_quadric_error(mesh, face_count: int = 1, output_dir: str = '../assets/results/assignment1'):
    """
...
if __name__ == '__main__':
    ...
    try:
        ...
        _ = subdivision_loop(mesh, iterations=SUBDIVISION, output_dir=OUTPUT_DIR)
        _ = simplify_quadric_error(mesh, face_count=DECIMATION, output_dir=OUTPUT_DIR)
    except Exception as e:
        raise e
